 ...
 * @param {String} predicate the object of a triple.
 */
function expandPredicate (context, predicate, callback) {

    if (!predicate || !context) {
        return callback(new Error('No context or predicate.'));
    }
    ...
    jsonld.expand(docToExpand, function (err, expanded) {
        ...
        return callback(null, Object.keys(expanded)[0]);
    });
}